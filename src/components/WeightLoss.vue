    ...
    <section class="program-page">
      <div class="container">
        <div class="program-header">
          ...
          <p>Сбалансированное питание для поддержания веса и здоровья. Включает все необходимые питательные вещества.</p>
        </div>
...
export default {
  ...
  data() {
    return {
      programs: {
        1: {name: "Программа для похудения", price: "2 800 ₽ / неделя" },
      },
      weeklyMenu: {
        monday: [
          {
